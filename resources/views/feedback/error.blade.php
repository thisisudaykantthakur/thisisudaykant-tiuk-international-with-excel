    ...
    <div class="container">
        ...
        <div class="row">
            <div  style="margin-top:20px;">
                <h4><img src="{{URL('/images/t.png')}}" height="30" width="20"> | Authentication Error</h4>
                <hr>
                <p>Dear User <br><br> Please Register your email and get it verified then login to this system. <br><br>Thank you.</p>
            </div>
        </div>
        <hr>
