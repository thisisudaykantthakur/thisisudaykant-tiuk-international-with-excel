    ...
    <div class="container">
        ...
        <div class="row">
            <div  style="margin-top:20px;">
                <h4><img src="{{URL('/images/t.png')}}" height="30" width="20"> | Login to tiuk System</h4>
                <hr>
                <form action="{{ route('login-user') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="Enter Your Email Address" name="email" value="{{ old('email') }}" autocomplete="off">
                        <span class="text-danger">@error('email'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="password" class="form-control" placeholder="Enter Your Password" name="password" value="" autocomplete="off">
                        <span class="text-danger">@error('password'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-block btn-primary" type="submit">Login</button><br>
                        <a href="auth.registration" class="link-a">&#183;New User ? Register here</a>
                    </div>
                </form>
            </div>
        </div>
